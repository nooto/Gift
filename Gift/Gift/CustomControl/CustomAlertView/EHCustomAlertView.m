...
@property (nonatomic, assign) id<EHCustomAlertViewDelegate> m_delegate;
@end
...
-(id)initWithTitle:(NSString*)title message:(NSString*)message  leftButton:(NSString*)leftTitle rightButton:(NSString*)rightTitle selectActin:(void(^)(NSInteger index))complete{
    if (self  = [self initWithTitle:title message:message leftButton:leftTitle rightButton:rightTitle]) {
...
//        self.isClearKeyWindow = NO;
        ...
        _messageColor = Color_black_50;
        _titleColor = Color_black_50;
        _leftButtonTitleColor = _rightButtonTitleColor = Color_black_50;
        ...
        [titleLabel adjustLableForHeight];
        [self.mContentView addSubview:titleLabel];
        ...
        if (leftTitle.length >0 && rightTitle.length > 0) {
            ...
            linew.backgroundColor = [UIColor lightGrayColor];
...
-(void)setMessageFont:(UIFont *)messageFont{
    ...
    [self.mMessageLabel adjustLableForHeight];
    [self checkeMessageHieht];
...
-(void)buttonAction:(UIButton*)sender{
    ...
    if (_didSelcectButtonAtindex) {
        _didSelcectButtonAtindex(sender.tag);
    }
